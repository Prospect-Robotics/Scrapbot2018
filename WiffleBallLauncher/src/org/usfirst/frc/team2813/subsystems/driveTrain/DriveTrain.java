...
public class DriveTrain extends Subsystem {
	...
	private static final int ENCODERLEFTID = 0;
	private static final int ENCODERRIGHTID = 1;
	private static final int PID_LOOP = 0;
	
	private static final WPI_TalonSRX driveTrainLeft = CreateTalonSRX.createDefaultWPITalonVictorSlave(LEFTTALONID, LEFTVICTORID);
	private static final WPI_TalonSRX driveTrainRight = CreateTalonSRX.createDefaultWPITalonVictorSlave(RIGHTTALONID, RIGHTVICTORID);
    ...
    /**
     * Gets mean distance for drive train encoders
     * @return distance
     */
    public static double getDistance() {
    	return ConfigEncoderForTalon.getDefaultDistance(driveTrainLeft, PID_LOOP)*
    			ConfigEncoderForTalon.getDefaultDistance(driveTrainRight, PID_LOOP)/2;
    }
